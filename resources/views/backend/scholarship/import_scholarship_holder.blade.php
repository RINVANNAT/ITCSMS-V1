...
@section ('title', trans('labels.backend.scholarships.title') . ' | ' . trans('labels.backend.scholarships.import_holder'))
...
@section('content')
    ...
    {!! Form::open(['route' => 'admin.scholarship.import_holder','id' => 'import_scholarship_holder', 'role'=>'form','files' => true])!!}
