...
@section('content')
    ...
    {!! Form::open(['route' => 'admin.student.import_custom_I1_student','id' => 'import_form_student', 'role'=>'form','files' => true])!!}
        ...
        <div class="box-body">
            <div class="row no-margin">
                <div class="form-group col-sm-12" style="padding: 20px;">
                    <span>Select an excel with right format and make sure that this is to import student <strong class="text-danger"> T1 & I1 (Engineer) </strong> </span>
                </div>
            </div>
