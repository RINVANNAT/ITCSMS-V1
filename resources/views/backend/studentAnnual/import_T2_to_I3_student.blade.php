...
@section('content')
    ...
    {!! Form::open(['route' => 'admin.student.import_T2_to_I3_student','id' => 'import_form_student', 'role'=>'form','files' => true])!!}
        ...
        <div class="box-body">
            <div class="row no-margin">
                <div class="form-group col-sm-12" style="padding: 20px;">
                    <span>Select an excel with right format and make sure that this is to import student <strong class="text-danger"> T2(DUT) to I3(Engineer) </strong> </span>
                </div>
            </div>
