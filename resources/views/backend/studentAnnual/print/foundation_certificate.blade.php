                    ...
                    <div class="col-md-6 col-xs-6">
                        <div class="khmer_section" style="padding: 10mm 10mm 10mm 3mm">
                            ...
                            <div class="row" style="margin-top: 10mm">
                                <div class="col-md-6">
                                    <p class="left">និស្សិតឈ្មោះ&nbsp;&nbsp;&nbsp;៖ <strong><span style="font-family: 'khmer_niroth' !important; font-size: 14px">{{$student['name_kh']}}</span></strong></p>
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <p class="tran-content line-height">
                                        បានបញ្ចប់ថ្នាក់ឆ្នាំសិក្សាមូលដ្ឋានដោយជោគជ័យនៅ វិទ្យាស្ថានបច្ចេកវិទ្យាកម្ពុជាក្នុងឆ្នាំសិក្សា {{$student['academic_year_kh']}}។
                                    </p>
                                </div>
                            </div>
                            <div class="row">
