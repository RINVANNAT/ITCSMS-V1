...
@section('content')
    {!! Form::open(['route' => 'admin.candidate.popup_store', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post']) !!}
    ...
    <div class="box box-success">
        <div class="box-body">
            <div class="pull-left">
                <a href="{!! route('admin.candidates.index') !!}" class="btn btn-danger btn-xs">{{ trans('buttons.general.cancel') }}</a>
            </div>
