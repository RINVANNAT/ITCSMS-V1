...
<div class="form-group">
    ...
    <div class="col-lg-4">
        {!! Form::text('prefix_id', null, ['class' => 'form-control']) !!}
    </div>
    {!! Form::label('name', trans('labels.backend.highSchools.fields.locp_code'), ['class' => 'col-lg-2 control-label']) !!}
    <div class="col-lg-4">
        {!! Form::text('locp_code', null, ['class' => 'form-control']) !!}
    </div>
</div><!--form control-->
<div class="form-group">
    {!! Form::label('name', trans('labels.backend.highSchools.fields.d_id'), ['class' => 'col-lg-2 control-label']) !!}
    <div class="col-lg-4">
        {!! Form::text('d_id', null, ['class' => 'form-control']) !!}
    </div>
    {!! Form::label('name', trans('labels.backend.highSchools.fields.locd_code'), ['class' => 'col-lg-2 control-label']) !!}
    <div class="col-lg-4">
        {!! Form::text('locd_code', null, ['class' => 'form-control']) !!}
    </div>
</div><!--form control-->
<div class="form-group">
    {!! Form::label('name', trans('labels.backend.highSchools.fields.c_id'), ['class' => 'col-lg-2 control-label']) !!}
    <div class="col-lg-4">
        {!! Form::text('c_id', null, ['class' => 'form-control']) !!}
    </div>
    {!! Form::label('name', trans('labels.backend.highSchools.fields.locc_code'), ['class' => 'col-lg-2 control-label']) !!}
    <div class="col-lg-4">
        {!! Form::text('locc_code', null, ['class' => 'form-control']) !!}
    </div>
</div><!--form control-->
<div class="form-group">
    {!! Form::label('name', trans('labels.backend.highSchools.fields.v_id'), ['class' => 'col-lg-2 control-label']) !!}
    <div class="col-lg-4">
        {!! Form::text('v_id', null, ['class' => 'form-control']) !!}
    </div>
    {!! Form::label('name', trans('labels.backend.highSchools.fields.locv_code'), ['class' => 'col-lg-2 control-label']) !!}
    <div class="col-lg-4">
        {!! Form::text('locv_code', null, ['class' => 'form-control']) !!}
    </div>
</div><!--form control-->
<div class="form-group">
