...
@section ('title', trans('labels.backend.studentBac2s.index_title') . ' | ' . trans('labels.backend.studentBac2s.sub_import_title'))

@section('page-header')
    <h1>
        {{ trans('labels.backend.studentBac2s.index_title') }}
        <small>{{ trans('labels.backend.studentBac2s.sub_import_title') }}</small>
    </h1>
@endsection

@section('content')

    {!! Form::open(['route' => 'admin.configuration.studentBac2.import','id' => 'import_form_student', 'role'=>'form','files' => true])!!}
    <div class="box box-success">
        <div class="box-header with-border">
            <h3 class="box-title">{{ trans('labels.backend.studentBac2s.sub_import_title') }}</h3>
        </div><!-- /.box-header -->
