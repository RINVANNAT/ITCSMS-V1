...
@section('content')
    <div class="box box-success">
        ...
        <div class="box-body">
            <div>
                <table class="table table-striped table-bordered table-hover dt-responsive nowrap" cellspacing="0" width="100%" id="grades-table">
                    <thead>
                    <tr>
    ...
    <script>
        $(function() {
            $('#grades-table').DataTable({
                ...
                ajax: {
                    url: '{!! route('admin.configuration.grade.data') !!}',
                    method: 'POST'
                },
                columns: [
                    { data: 'code', name: 'code'},
