...
@section ('title', trans('labels.backend.degrees.index_title'))

@section('page-header')
    <h1>
        {{ trans('labels.backend.degrees.index_title') }}
...
@section('content')
    <div class="box box-success">
        <div class="box-header with-border">
            <h3 class="box-title">{{ trans('labels.backend.degrees.index_title') }}</h3>
