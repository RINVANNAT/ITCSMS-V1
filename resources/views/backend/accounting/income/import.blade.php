...
@section('content')
    ...
    {!! Form::open(['route' => 'admin.accounting.income.import','id' => 'import_form_income', 'role'=>'form','files' => true])!!}
    <div class="box box-success">
        <div class="box-header with-border">
            <h3 class="box-title">{{ trans('labels.backend.incomes.sub_import_title') }}</h3>
        </div><!-- /.box-header -->
