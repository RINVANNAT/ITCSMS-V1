    ...
    <div class="col-md-10 col-md-offset-2">
        <div class="row">
            <div class="col-md-12">
                <label for="all-weeks">
                    <input type="checkbox"
                           class="square all-weeks"> {{ trans('labels.backend.schedule.timetable.modal_clone.body.all_weeks') }}
                </label>
            </div>
        </div>
    </div>
...
<div class="form-group">
    <div class="col-md-offset-2 col-md-8">
        <button class="btn btn-primary btn-sm"
               id="submit_reset">{{ trans('buttons.backend.schedule.timetable.modal_reset.reset') }}</button>
