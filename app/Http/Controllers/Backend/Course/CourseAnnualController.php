...
//        dd($courseAnnual->academic_year->name_latin);
        $groups = $this->getStudentGroupFromDB();
...
//        dd($groups);
//        ($studentGroup != "undefined")?($groups = $groups->where('studentAnnuals.group', '=',$studentGroup)->lists('group')): ($groups = $groups->lists('group'));
