...
Route::group(['namespace' => 'DistributionDepartment', 'prefix' => 'distribution-department'], function () {
    ...
    Route::get('{grade_id}/{academic_year_id}/get-generate-page', 'DistributionDepartmentController@getGeneratePage')->name('distribution-department.get-generate-page');
    ...
    Route::get('/{grade_id}/{academic_year_id}/get-student-priority-department', 'DistributionDepartmentController@getStudentPriorityDepartment')->name('distribution-department.get-student-priority-department');
    ...
    Route::get('{grade_id}/{academic_year_id}/export', 'DistributionDepartmentController@export')->name('distribution-department.export');
    Route::get('{grade_id}/{academic_year_id}/export-all', 'DistributionDepartmentController@exportAll')->name('distribution-department.export-all');
    Route::get('{grade_id}/{academic_year_id}/print-each-department', 'DistributionDepartmentController@printEachDepartment')->name('distribution-department.print-each-department');
    Route::get('{grade_id}/{academic_year_id}/print-all', 'DistributionDepartmentController@printAll')->name('distribution-department.print-all');

    Route::get('{grade_id}/{academic_year_id}/get-import', 'DistributionDepartmentController@getImportPage')->name('distribution-department.get-import');
